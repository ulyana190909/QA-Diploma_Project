...
4. Кликнуть на окно "Продолжить"
5. Оценить время отправки заявки и результат.
Должнен появиться текст в поле "Номер карты" : "Поле обязательно для заполнения".  
___
_Сценарий 2._  
...
4. Кликнуть на окно "Продолжить"
5. Оценить время отправки заявки и результат.
Должен появиться текст в поле "Месяц": "Поле обязательно для заполнения".
___
_Сценарий 7._  
...
4. Кликнуть на окно "Продолжить"
5. Оценить время отправки заявки и результат.
Должнен появиться текст в поле "Месяц": "Поле обязательно для заполнения".  
___
_Сценарий 11._  
...
4. Кликнуть на окно "Продолжить"
5. Оценить время отправки заявки и результат.
Должнен появиться текст в поле "CVC/CVV" : "Поле обязательно для заполнения".  
___
_Сценарий 19_  
...
1. Оценить время отправки заявки и результат.  
Во всех полях должен появиться текст: "Поле обязательно для заполнения".  
